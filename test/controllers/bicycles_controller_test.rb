...
class BicyclesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bicycle" do
    assert_difference('Bicycle.count') do
      post bicycles_url, params: { bicycle: { description: @bicycle.description, name: @bicycle.name } }
    end
  ...
  test "should update bicycle" do
    patch bicycle_url(@bicycle), params: { bicycle: { description: @bicycle.description, name: @bicycle.name } }
